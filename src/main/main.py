...
if __name__ == '__main__':
    ...
    activity_service = ActivityService(activity_repository, person_repository, person_service, undoController,
                                       generate=True)
    ui = UI(person_service, activity_service, undoController)
    ui.create_menu()
    # gui = GUI(person_service, activity_service, undo_service)
    # gui.start()
