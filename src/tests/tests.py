...
class PersonServiceTest(unittest.TestCase):
    ...
    def test_add_person(self):
        ...
        with self.assertRaises(PersonServiceException):
            person_service.add_person(1246, "Robb Flynn", "0745436548")
        with self.assertRaises(PersonServiceException):
            person_service.add_person(1546, "Robb Flynn", "0745236548")
    ...
    def test_remove_person(self):
        ...
        with self.assertRaises(PersonServiceException):
            person_service.remove_person(1256)
...
class ActivityServiceTest(unittest.TestCase):
    ...
    def test_remove_person_from_activities(self):
        ...
        activity_service.remove_person_from_activities(4256)
        activity_list = list(activity_service.activities)
        ...
        activity_service.remove_person_from_activities(1234)
        activity_list = list(activity_service.activities)
